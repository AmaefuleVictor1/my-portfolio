...
<html lang="en">
    <head>
        ...
        <title>Ebukamaefule Portfolio</title>
        <!-- Favicon-->
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="./assets/[rebuka.ai]_0a2a5c1c-d2d4-4347-901e-e48b7d4f8d83-img_0527-copy_JPAQDY (3).png" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
                            ...
                            <!-- <h2 class="text-center p-3 text-gradient" style="font-weight:500;">The Future is Here</h2> -->
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-light mb-4">My name is <span class="text-gradient fw-bold" style="font-weight:700; font-size:25px;">Amaefule Victor Chukwuebuka</span> and I help brands grow.</p>
